...
const jsonUrls = {
  menu: env.VITE_JSONBIN_MENU_URL ?? '/data/menu.json',
  categories: env.VITE_JSONBIN_CATEGORIES_URL ?? '/data/categories.json',
  specials: env.VITE_JSONBIN_SPECIALS_URL ?? '/data/specials.json',
  translationsEn: env.VITE_JSONBIN_TRANSLATIONS_EN_URL ?? '/data/translations.en.json',
  translationsEs: env.VITE_JSONBIN_TRANSLATIONS_ES_URL ?? '/data/translations.es.json',
};
